...
class Options:
    ...
    def __init__(self):
        ...
        # Size parameters
        parser.add_argument('--im-sz', default=288, type=int, help='Image size')
        parser.add_argument('--sk-sz', default=288, type=int, help='Sketch size')
        parser.add_argument('--dim-out', default=256, type=int, help='Output dimension of sketch and image')
        # Model parameters
        parser.add_argument('--batch-size', default=64, type=int, help='Batch size')
        parser.add_argument('--samples_per_class', default=8, type=int, help='samples_per_class')
        parser.add_argument('--ngpu', type=int, default=1, help='0 = CPU, 1 = CUDA, 1 < DataParallel')
        parser.add_argument('--num-workers', type=int, default=0, help='Number of workers in data loader')
        ...
        parser.add_argument('--lr', type=lambda x: utils.restricted_float(x, [1e-5, 0.5]), default=0.00001, metavar='LR',
