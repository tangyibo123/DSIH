...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=128, smoothing_value=0, zero_head=False):
    ...
    def forward(self, x, labels=None):
        ...
        ircode = self.logsoftmax(part_tokens[:, 0])
        ...
        if labels is not None:
            ...
            return loss, part_logits, ircode
        else:
            return part_logits
